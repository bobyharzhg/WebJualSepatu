    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            if ($user['role'] == 'Admin') { ?>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="<?= site_url('Matakuliah/') ?>">
                        <i class="fas fa-fw fa-users"></i>
                        <span>Matakuliah</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link collapsed" href="<?= site_url('Sepatu/') ?>">
                        <i class="fas fa-fw fa-users"></i>
                        <span>Sepatu</span>
                    </a>
                </li>
            ...
            ?>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="<?= site_url('Profil/Sepatu/') ?>">
                        <i class="fas fa-fw fa-users"></i>
                        <span>Sepatu</span>
                    </a>
                </li>
